...
##Installation
	...
	4.	Upload the plugin folder to /wp-content/plugins/ or install it via Plugins → Add New → Upload Plugin.
	5.	Activate the plugin from Plugins → Installed Plugins.
	6.	Open the block editor, select a block, and use Conditional Blocks → Language conditions to control visibility by Polylang language.
